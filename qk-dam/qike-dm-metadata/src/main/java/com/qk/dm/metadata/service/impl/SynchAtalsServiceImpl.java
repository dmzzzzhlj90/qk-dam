...
public class SynchAtalsServiceImpl {
  ...
  public SynchAtalsServiceImpl(
      MtdLabelsAtlasRepository mtdLabelsAtlasRepository, MtdAtlasService mtdAtlasService) {
  ...
  public void synchLabels() {
    List<MtdLabelsAtlas> labelAllList =
        mtdLabelsAtlasRepository.findAllBySynchStatusInOrderByGmtCreateAsc(
