...
public class AtlasTestServiceImpl {
  ...
  /** 树形返回 用于检索 Atlas 中所有类型定义的批量检索 API */
  ...
  public void createAtlasTypeDefs() throws AtlasServiceException {
    ...
    AtlasClassificationDef atlasClassificationDef =
        new AtlasClassificationDef("test1234", "test1234");
  ...
  public void deleteClassification() throws AtlasServiceException {
    // 删除给定分类
    AtlasConfig.getAtlasClientV2()
        .deleteClassification("a16f051d-4756-42c8-acc6-d6925f0a3900", "test123");
  }

  public void removeClassification() throws AtlasServiceException {
    // 向由 guid 表示的现有实体添加分类
    List<AtlasClassification> classificationList =
        Stream.of(new AtlasClassification()).collect(Collectors.toList());
    // 删除给定分类及关联实体分类
    AtlasConfig.getAtlasClientV2()
        .removeClassification("483c95fc-f134-4f25-aff0-45d6ebbe82bd", "分类名称", "关联实体guid");
  }
  ...
  public void addClassification() throws AtlasServiceException {
    ...
    request.setEntityGuids(
        Stream.of("a16f051d-4756-42c8-acc6-d6925f0a3900").collect(Collectors.toList()));
