...
public class DsDataSourceController {
    ...
    public DefaultCommonResult<List<String>> getDataType(){
        return new DefaultCommonResult(ResultCodeEnum.OK,dsDataSourceService.getDataType());
    }
     ...
     */
    @PostMapping("/connect")
    public DefaultCommonResult<Boolean> dsDataSoureceConnect(@RequestBody DsDatasourceVO dsDatasourceVO){
        return  new DefaultCommonResult(ResultCodeEnum.OK,dsDataSourceService.dsDataSoureceConnect(dsDatasourceVO));
    }
}