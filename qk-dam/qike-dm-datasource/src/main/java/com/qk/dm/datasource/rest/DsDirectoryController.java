...
public class DsDirectoryController {
    ...
    @Autowired
    public DsDirectoryController(
            DsDirectoryService dsDirectoryService) {
    ...
    public DefaultCommonResult<List<DsDirectoryVO>> getDsDirectory(@RequestBody(required = false) Pagination pagination) {
    ...
    public DefaultCommonResult addDsDirentory(
