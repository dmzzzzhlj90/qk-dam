...
import com.qk.dm.datasource.util.GsonUtil;
...
public class DsDataSourceServiceImpl implements DsDataSourceService {
    ...
    @Autowired
    public DsDataSourceServiceImpl(DsDirService dsDirService, EntityManager entityManager, DsDatasourceRepository dsDatasourceRepository) {
    ...
    private void setCodeTableValues(DsDatasource dsd, DsDatasourceVO dsDatasourceVO) {
        if (StringUtils.isNotBlank(dsd.getDataSourceValues())){
            dsDatasourceVO.setDataSourceValuesMap(GsonUtil.fromJsonString(dsd.getDataSourceValues(),
     ...
     * @param dsDataSourceParamsVO
     */
    private void checkCondition(BooleanBuilder booleanBuilder, QDsDatasource qDsDatasource, DsDataSourceParamsVO dsDataSourceParamsVO) {
        ...
        if (!StringUtils.isEmpty(dsDataSourceParamsVO.getDataSourceName())) {
            booleanBuilder.and(qDsDatasource.homeSystem.contains(dsDataSourceParamsVO.getDataSourceName()));
        }
