...
public class DasApiCreateConfigController {
    ...
    public DefaultCommonResult<Map<String, String>> getDasApiCreateOrderParaHeaderInfo() {
        return DefaultCommonResult.success(ResultCodeEnum.OK, dasApiCreateConfigService.getDasApiCreateOrderParaHeaderInfo());
    }
    ...
    public DefaultCommonResult<List<String>> getDasApiCreateParasCompareSymbol() {
        return DefaultCommonResult.success(ResultCodeEnum.OK, dasApiCreateConfigService.getDasApiCreateParasCompareSymbol());
    }
    ...
    public DefaultCommonResult<Map<String, String>> getDasApiCreateParasSortStyle() {
        return DefaultCommonResult.success(ResultCodeEnum.OK, dasApiCreateConfigService.getDasApiCreateParasSortStyle());
    }
    ...
    public DefaultCommonResult<List<String>> getAllDataBase(@RequestParam("dbType") String dbType) {
        return DefaultCommonResult.success(ResultCodeEnum.OK, dasApiCreateConfigService.getAllDataBase(dbType));
    }
    ...
    public DefaultCommonResult<List<String>> getAllTable(
        ...
        return DefaultCommonResult.success(ResultCodeEnum.OK, dasApiCreateConfigService.getAllTable(dbType, server, dbName));
    }
    ...
    public DefaultCommonResult<List> getAllColumn(
        ...
        return DefaultCommonResult.success(ResultCodeEnum.OK, dasApiCreateConfigService.getAllColumn(dbType, server, dbName, tableName));
    }
    ...
    public DefaultCommonResult<List<String>> getAllConnType() {
        return DefaultCommonResult.success(ResultCodeEnum.OK, dasApiCreateConfigService.getAllConnType());
    }
    ...
    DefaultCommonResult<List<ResultDatasourceInfo>> getResultDataSourceByType(@PathVariable("type") String type) {
        return DefaultCommonResult.success(ResultCodeEnum.OK, dasApiCreateConfigService.getResultDataSourceByType(type));
    }
    ...
    @Auth(bizType = BizResource.DAS_API_CREATE_CONFIG, actionType = RestActionType.GET)
    public DefaultCommonResult<ResultDatasourceInfo> getResultDataSourceByConnectName(@PathVariable("connectName") String connectName) {
        return DefaultCommonResult.success(ResultCodeEnum.OK, dasApiCreateConfigService.getResultDataSourceByConnectName(connectName));
    }
    ...
    public DefaultCommonResult<List<MtdAtlasEntityType>> getAllEntityType() {
        return DefaultCommonResult.success(ResultCodeEnum.OK, dasApiCreateConfigService.getAllEntityType());
    }
    ...
    DefaultCommonResult<MtdApi> mtdDetail(@RequestBody @Validated MtdApiParams mtdApiParams) {
        return DefaultCommonResult.success(ResultCodeEnum.OK, dasApiCreateConfigService.mtdDetail(mtdApiParams));
    }
}
