...
public class DasSyncOpenApiServiceImpl implements DasSyncOpenApiService {
  ...
  private void getDasApiRegister(
      List<DasApiRegisterVO> dasApiRegisterVOList, DasApiDirVO dasApiDirVO, OpenApi3 openApi3) {
    ...
    for (String pathKey : apiMap.keySet()) {
      ...
      DasApiRegisterVO dasApiRegisterVO =
          buildRegisterVO(
              schemaMap, apiMap, pathKey, title, apiBasicInfoVOBuilder, apiRegisterVOBuilder);
  ...
  private DasApiRegisterVO buildRegisterVO(
      Map<String, Schema> schemaMap,
      Map<String, Path> apiMap,
      String pathKey,
      String title,
      DasApiBasicInfoVO.DasApiBasicInfoVOBuilder apiBasicInfoVOBuilder,
