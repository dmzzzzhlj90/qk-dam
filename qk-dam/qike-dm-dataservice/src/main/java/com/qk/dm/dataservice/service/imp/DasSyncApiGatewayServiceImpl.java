...
//    systemParam.put(ApiSixConstant.API_SIX_HEAD_KEY, apiSixConnectInfo.getHeadKeyValue());
//    upstreamContext.setParams(systemParam);
//    List upstreamInfoIds =
//        apiGatewayManager.apiSixUpstreamInfoIds(
//            ApiSixConnectInfo.GATEWAY_TYPE_API_SIX, upstreamContext);
...
//    Map<String, String> systemParam = new HashMap<>();
//    systemParam.put(
//        ApiSixConstant.API_SIX_ADMIN_SERVER_URL_KEY, apiSixConnectInfo.getAdminServerUrl());
//    systemParam.put(ApiSixConstant.API_SIX_HEAD_KEY, apiSixConnectInfo.getHeadKeyValue());
//    serverContext.setParams(systemParam);
//    List serviceInfoList =
//        apiGatewayManager.getServiceInfo(ApiSixConnectInfo.GATEWAY_TYPE_API_SIX, serverContext);
...
//    serverContext.setParams(systemParam);
//    List serviceInfoIds =
//        apiGatewayManager.apiSixServiceInfoIds(
//            ApiSixConnectInfo.GATEWAY_TYPE_API_SIX, serverContext);
//    return serviceInfoIds;
//  }
//
//  private int singleSyncRegisterApi(
//      Map<String, List<DasApiBasicInfo>> apiBasicInfoMap, String upstreamId, String serviceId) {
...
//          getApiSixRouteInfo(apiBasicInfoMap, upstreamId, serviceId, dasApiRegister);
...
//  }
//
//  private int singleSyncRegisterApiByPath(
//      Map<String, List<DasApiBasicInfo>> apiBasicInfoMap,
//      String upstreamId,
//      String serviceId,
//      String apiPath) {
...
//                          SyncStatusEnum.CREATE_SUCCESS_UPLOAD.getCode())));
//
//      for (DasApiRegister dasApiRegister : dasApiRegisterIterable) {
//        boolean flag =
//            setRouteInfoByPath(
//                apiBasicInfoMap, upstreamId, serviceId, routeContext, routeIdList, dasApiRegister);
//        updateApiRegisterStatus(dasApiRegister, flag, successfulNum, failNum);
//      }
//      LOG.info("成功同步注册Api个数:【{}】", successfulNum);
//      LOG.info("失败同步注册Api个数:【{}】", failNum);
...
//  }
//
//  private void updateApiRegisterStatus(
//      DasApiRegister dasApiRegister,
//      boolean flag,
//      AtomicInteger successfulNum,
//      AtomicInteger failNum) {
//    if (flag) {
//      dasApiRegister.setStatus(SyncStatusEnum.CREATE_SUCCESS_UPLOAD.getCode());
...
//    } else {
//      dasApiRegister.setStatus(SyncStatusEnum.CREATE_FAIL_UPLOAD.getCode());
//      dasApiRegisterRepository.saveAndFlush(dasApiRegister);
...
//  }
//
//  private boolean setRouteInfoByPath(
//      Map<String, List<DasApiBasicInfo>> apiBasicInfoMap,
//      String upstreamId,
//      String serviceId,
//      RouteContext routeContext,
...
//  }
//
//  private ApiSixRouteInfo getApiSixRouteInfo(
//      Map<String, List<DasApiBasicInfo>> apiBasicInfoMap,
//      String upstreamId,
//      String serviceId,
//      DasApiRegister dasApiRegister) {
...
//        dasApiBasicInfoRepository.findAll(
//            QDasApiBasicInfo.dasApiBasicInfo.apiType.eq(DasConstant.REGISTER_API_CODE));
...
//  }
//
//  private void initApiSixGatewayRoute(
//      ApiSixRouteInfo apiSixRouteInfo, String apiId, RouteContext routeContext) {
