...
public class SqlExecuteUtils {
    ...
    public static String mysqlExecuteSQL(String tableName,
        ...
        if (reqParams.size() > 0) {
            ...
            for (String paraName : reqParams.keySet()) {
                ...
                //字段映射操作比较符号
                switchOperationSymbol(whereBuffer, column, value, conditionType);
            }
            sql = sql + whereBuffer;
        }
        return sql;
     ...
     * @param conditionType
     */
    private static void switchOperationSymbol(StringBuilder whereBuffer, String column, String value, String conditionType) {
