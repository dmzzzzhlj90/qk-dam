...
public class AtyUserMapperImpl implements AtyUserMapper {
    ...
    @Override
    public AtyUserExcelVO userExcel(AtyUserInfoVO atyUserInfoVO) {
        if ( atyUserInfoVO == null ) {
            return null;
        }
        ...
        atyUserExcelVO.setCreatedTime( com.qk.dm.authority.mapstruct.AtyUserMapper.getTime(atyUserInfoVO.getCreatedTimestamp()) );
