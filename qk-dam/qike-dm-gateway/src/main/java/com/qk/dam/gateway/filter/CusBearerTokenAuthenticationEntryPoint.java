...
public class CusBearerTokenAuthenticationEntryPoint implements ServerAuthenticationEntryPoint {
...
//			String wwwAuthenticate = computeWWWAuthenticateHeaderValue(parameters);
			...
			URI uri = URI.create("http://auth-client:8780/oauth2/accessToken?fontUri=http://www.baidu.com");
