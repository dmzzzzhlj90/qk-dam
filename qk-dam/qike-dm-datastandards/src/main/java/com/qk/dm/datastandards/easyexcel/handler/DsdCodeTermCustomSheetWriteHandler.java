...
public class DsdCodeTermCustomSheetWriteHandler implements SheetWriteHandler {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DsdCodeTermCustomSheetWriteHandler.class);
    ...
    public void afterSheetCreate(WriteWorkbookHolder writeWorkbookHolder, WriteSheetHolder writeSheetHolder) {
        ...
        DataValidationConstraint constraint = helper.createExplicitListConstraint(dsdCodeDirLevelList.toArray(new String[dsdCodeDirLevelList.size()]));
