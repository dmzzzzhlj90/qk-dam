...
public class DsdCodeTermUploadDataListener extends AnalysisEventListener<DsdCodeTermVO> {
    ...
    public DsdCodeTermUploadDataListener(DsdExcelBatchService dsdExcelBatchService, String codeDirId) {
    ...
    public void saveData() {
        Map<String, String> dsdCodeDirLevelMap = new HashMap<>();
        Set<String> dsdCodeDirLevelSet = new HashSet<>();
        ...
        list.forEach(
                dsdCodeTermVO -> {
                    ...
                    dsdCodeDirLevelSet.add(dsdCodeTerm.getCodeDirLevel());
                    dsdCodeDirLevelMap.put(dsdCodeTermVO.getCodeId(), dsdCodeTermVO.getCodeDirLevel());
                    codeTermList.add(dsdCodeTerm);
                });
        // 批量新增
        dsdExcelBatchService.addDsdCodeTermBatch(codeTermList,dsdCodeDirLevelSet, dsdCodeDirLevelMap, codeDirId);
    }
}
