...
// * @since 1.0.0
// */
//@Deprecated(since = "1.0.1-SNAPSHOT", forRemoval = true)
//@Slf4j
//@RestController
//@RequestMapping("/0/code/term")
...
//    public DefaultCommonResult bulkAddDsdCodeTerm(@RequestBody @Validated List<DsdCodeTermVO> dsdCodeTermVOList) {
