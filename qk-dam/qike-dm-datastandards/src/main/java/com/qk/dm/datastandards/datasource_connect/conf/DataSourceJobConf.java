...
//    static {
//        dataSourceConf =
//                new Yaml().loadAs(ResourceUtil.getStream("datasource-connect-extractor-task.yml"), DataSourceYamlVO.class);
//    }
//
...
//                        .filter(dataSourceJobYamlVO -> jobName.equals(dataSourceJobYamlVO.getName()))
//                        .findFirst()
//                        .orElse(null);
