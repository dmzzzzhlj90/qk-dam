...
public class DsdExcelBatchService {
  ...
  public void addDsdCodeTermBatch(
      List<DsdCodeTerm> codeTermList,
      Set<String> dsdCodeDirLevelSet,
      Map<String, String> dsdCodeDirLevelMap,
      String codeDirId) {
  ...
  private void saveDsdCodeTerm(
    ...
    Map<String, List<DsdCodeDir>> dsdDirLevelMap =
        dsdCodeDirAllList.stream().collect(Collectors.groupingBy(DsdCodeDir::getCodeDirLevel));
    Predicate existDataPredicate =
        QDsdCodeTerm.dsdCodeTerm
            .codeDirLevel
            .in(dsdCodeDirLevelSet)
  ...
  private void saveDsdCodeTermByCodeDirId(
      List<DsdCodeTerm> codeTermList, Map<String, String> dsdCodeDirLevelMap, String codeDirId) {
    Optional<DsdCodeDir> dsdCodeDir =
