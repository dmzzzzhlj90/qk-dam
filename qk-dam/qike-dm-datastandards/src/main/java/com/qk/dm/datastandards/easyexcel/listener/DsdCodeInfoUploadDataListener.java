...
public class DsdCodeInfoUploadDataListener extends AnalysisEventListener<DsdCodeInfoVO> {
    ...
    private void saveData() {
        if (list != null && list.size() > 0) {
            ...
            if (!StringUtils.isEmpty(codeDirId)) {
                ...
                Map<String, List<DsdCodeInfoVO>> tableCodeMap = list.stream().
    ...
    private void getDataListAllByCodeDirId(Set<String> tableCodeSet, List<DsdCodeInfo> dataList,
    ...
    private void getDataListAll(Set<String> tableCodeSet, Set<String> codeDirLevelSet, List<DsdCodeInfo> dataList,
                                Map<String, List<DsdCodeInfoVO>> tableCodeMap) {
        for (String tableCode : tableCodeMap.keySet()) {
            List<DsdCodeInfoVO> dsdCodeInfoVOList = tableCodeMap.get(tableCode);
            DsdCodeInfoVO dsdCodeInfoVO = dsdCodeInfoVOList.get(0);
    ...
    private void setCodeInfoConfigs(List<DsdCodeInfoVO> dsdCodeInfoVOList, List<Map<String, String>> configFields) {
