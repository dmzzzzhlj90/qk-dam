...
public class DsdBasicInfoUploadDataListener extends AnalysisEventListener<DsdBasicinfoVO> {
    ...
    public DsdBasicInfoUploadDataListener(DsdExcelBatchService dsdExcelBatchService, String dirDsdId) {
    ...
    private void saveData() {
        ...
        // 批量新增
        dsdExcelBatchService.addDsdBasicInfoBatch(dsdBasicInfoList, dsdDirLevelSet, codeDirLevelMap, dirDsdId);
    }
}
