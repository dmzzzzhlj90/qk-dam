...
public class TestCaffeineCacheServiceImpl implements TestCaffeineCacheService {
    ...
    @Autowired
    public TestCaffeineCacheServiceImpl(DsdCodeInfoExtRepository dsdCodeInfoExtRepository, Cache<String, Object> caffeineCache) {
...
//        DsdCodeInfoExt dsdCodeInfoExt = (DsdCodeInfoExt) caffeineCache.asMap().get(String.valueOf(id));
