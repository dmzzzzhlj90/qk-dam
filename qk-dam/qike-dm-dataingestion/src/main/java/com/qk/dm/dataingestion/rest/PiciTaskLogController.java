...
public class PiciTaskLogController {
    ...
    public DefaultCommonResult<Integer> modifyIsHiveByTableNameAndPici(@PathVariable(value = "tableName") String tableName,
                                                                       @PathVariable(value = "pici") String pici) throws BizException {
        return new DefaultCommonResult(ResultCodeEnum.OK, piciTaskLogService.modifyIsHiveByTableNameAndPici(tableName, pici));
    }
}
