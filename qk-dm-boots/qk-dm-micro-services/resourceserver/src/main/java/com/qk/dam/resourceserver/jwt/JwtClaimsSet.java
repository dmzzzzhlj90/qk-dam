...
/**
 * The {@link Jwt JWT} Claims Set is a JSON object representing the claims conveyed by a JSON Web
 * Token.
 *
...
public final class JwtClaimsSet implements JwtClaimAccessor {
  ...
  public static final class Builder {
    ...
    /**
     * Sets the subject {@code (sub)} claim, which identifies the principal that is the subject of
     * the JWT.
     *
    ...
    /**
     * Sets the audience {@code (aud)} claim, which identifies the recipient(s) that the JWT is
     * intended for.
     *
    ...
    /**
     * Sets the expiration time {@code (exp)} claim, which identifies the time on or after which the
    ...
    /**
     * Sets the not before {@code (nbf)} claim, which identifies the time before which the JWT MUST
    ...
    /**
     * Sets the issued at {@code (iat)} claim, which identifies the time at which the JWT was
     * issued.
     *
    ...
    /**
     * A {@code Consumer} to be provided access to the claims set allowing the ability to add,
     * replace, or remove.
     *
