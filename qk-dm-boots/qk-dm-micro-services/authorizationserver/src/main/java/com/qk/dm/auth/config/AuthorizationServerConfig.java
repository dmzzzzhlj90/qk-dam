...
public class AuthorizationServerConfig {
                                ...
                                innerRegisteredClient -> {
                                    var builder =
                                            RegisteredClient.withId(UUID.randomUUID().toString())
                                                    ...
                                                    .tokenSettings(
                                                            TokenSettings.builder().accessTokenTimeToLive(Duration.ofMinutes(
                                                                    innerRegisteredClient.getAccessTokenTimeToLive())).refreshTokenTimeToLive(
                                                                    Duration.ofMinutes(
                                                                            innerRegisteredClient.getRefreshTokenTimeToLive())).build()
                                                    )
                                                    .clientSettings(
    ...
    public ProviderSettings providerSettings(RegisteredClients registeredClients) {
        return ProviderSettings.builder().issuer(registeredClients.getIssuer()).build();
    }
}
