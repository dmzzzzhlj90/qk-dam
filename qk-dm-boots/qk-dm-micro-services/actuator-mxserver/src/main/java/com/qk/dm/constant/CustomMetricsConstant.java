...
public class CustomMetricsConstant {
     ...
     * 自定义指标_监控调度任务_指标名称
     */
    public static final String CUSTOM_TASK_SCHEDULER_PROCESS_INSTANCE = "custom_task_scheduler_process_instance";

    public static final String TASK_SCHEDULER_PROCESS_DEFINITION_CODE = "task_scheduler_process_definition_code";
