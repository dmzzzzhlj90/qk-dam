 ...
 */
package com.qk.dam.resourceserver.jwt;
...
/**
 * The JOSE header is a JSON object representing the header parameters of a JSON Web Token, whether
 * the JWT is a JWS or JWE, that describe the cryptographic operations applied to the JWT and
...
public final class JoseHeader {
  ...
  /**
   * Returns the JWK Set URL that refers to the resource of a set of JSON-encoded public keys, one
   * of which corresponds to the key used to digitally sign the JWS or encrypt the JWE.
   *
  ...
  /**
   * Returns the JSON Web Key which is the public key that corresponds to the key used to digitally
  ...
  /**
   * Returns the X.509 URL that refers to the resource for the X.509 public key certificate or
   * certificate chain corresponding to the key used to digitally sign the JWS or encrypt the JWE.
   *
  ...
  /**
   * Returns the X.509 certificate chain that contains the X.509 public key certificate or
   * certificate chain corresponding to the key used to digitally sign the JWS or encrypt the JWE.
   *
  ...
  /**
   * Returns the X.509 certificate SHA-1 thumbprint that is a base64url-encoded SHA-1 thumbprint
   * (a.k.a. digest) of the DER encoding of the X.509 certificate corresponding to the key used to
   * digitally sign the JWS or encrypt the JWE.
   *
  ...
  /**
   * Returns the X.509 certificate SHA-256 thumbprint that is a base64url-encoded SHA-256 thumbprint
   * (a.k.a. digest) of the DER encoding of the X.509 certificate corresponding to the key used to
   * digitally sign the JWS or encrypt the JWE.
   *
  ...
  /**
   * Returns the content type header that declares the media type of the secured content (the
   * payload).
   *
  ...
  public static final class Builder {
    ...
    /**
     * Sets the JWK Set URL that refers to the resource of a set of JSON-encoded public keys, one of
     * which corresponds to the key used to digitally sign the JWS or encrypt the JWE.
     *
    ...
    /**
     * Sets the JSON Web Key which is the public key that corresponds to the key used to digitally
     * sign the JWS or encrypt the JWE.
     *
    ...
    /**
     * Sets the X.509 URL that refers to the resource for the X.509 public key certificate or
     * certificate chain corresponding to the key used to digitally sign the JWS or encrypt the JWE.
     *
    ...
    /**
     * Sets the X.509 certificate chain that contains the X.509 public key certificate or
     * certificate chain corresponding to the key used to digitally sign the JWS or encrypt the JWE.
     *
    ...
    /**
     * Sets the X.509 certificate SHA-1 thumbprint that is a base64url-encoded SHA-1 thumbprint
     * (a.k.a. digest) of the DER encoding of the X.509 certificate corresponding to the key used to
     * digitally sign the JWS or encrypt the JWE.
     *
    ...
    /**
     * Sets the X.509 certificate SHA-256 thumbprint that is a base64url-encoded SHA-256 thumbprint
     * (a.k.a. digest) of the DER encoding of the X.509 certificate corresponding to the key used to
     * digitally sign the JWS or encrypt the JWE.
     *
    ...
    /**
     * Sets the content type header that declares the media type of the secured content (the
     * payload).
     *
    ...
    /**
     * A {@code Consumer} to be provided access to the headers allowing the ability to add, replace,
     * or remove.
     *
