...
public class UserInfoOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
  private final OpaqueTokenIntrospector delegate =
      new NimbusOpaqueTokenIntrospector(
          "https://auth-server:9901/oauth2/introspect", "client", "secret");
  ...
  private OAuth2AuthenticatedPrincipal makeUserInfoRequest(
      String token, OAuth2AuthenticatedPrincipal oAuth2AuthenticatedPrincipal) {
