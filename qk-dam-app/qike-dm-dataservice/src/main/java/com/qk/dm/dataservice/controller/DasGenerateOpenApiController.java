...
//  @Auth(bizType = BizResource.DAS_OPEN_API, actionType = RestActionType.GET)
    @GetMapping(value = "/{dirId}", produces = "application/json;charset=utf-8")
    public String generateOpenApi(@PathVariable("dirId") String dirId) {
        return dasGenerateOpenApiService.generateOpenApi(dirId);
    }
}
