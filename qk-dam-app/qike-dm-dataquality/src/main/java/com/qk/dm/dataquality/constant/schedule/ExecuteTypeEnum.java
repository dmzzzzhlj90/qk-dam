...
public enum ExecuteTypeEnum {
    NONE("NONE","无操作"),
    START_PROCESS("START_PROCESS","启动工作流"),
    REPEAT_RUNNING("REPEAT_RUNNING","重跑"),
    RECOVER_SUSPENDED_PROCESS("RECOVER_SUSPENDED_PROCESS","恢复运行流程"),
    START_FAILURE_TASK_PROCESS("START_FAILURE_TASK_PROCESS","启动失败任务流程"),
    STOP("STOP","停止"),
    PAUSE("PAUSE","暂停");
