...
public class RsaUtil {
    ...
    public static final String PUBLIC_KEY = "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAISbgSNbXyQgOdCqk5wff5naVLjkMGBp8MIrKQAW0YvRHzO2whgFeTaPHE+LJ01jigKRV6WK02Ge/mnqXFTYQuUCAwEAAQ==";
    public static final String PRIVATE_KEY = "";
    ...
    public static void main(String[] args) throws Exception {
        // 待加密数据
        String data = "shen123456";
        // 公钥加密
        System.out.println("-----------------加密和解密------------------------------");
        System.out.println("待加密的数据：" + data);
        String encrypt = RsaUtil.encryptByPublicKey(data, PUBLIC_KEY);
        System.out.println("加密后数据：" + encrypt);
        // 私钥解密
        String decrypt = RsaUtil.decryptByPrivateKey(encrypt, PRIVATE_KEY);
        System.out.println("解密后数据：" + decrypt);
    }
