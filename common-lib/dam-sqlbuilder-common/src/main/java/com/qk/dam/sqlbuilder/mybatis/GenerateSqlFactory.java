package com.qk.dam.sqlbuilder.mybatis;
...
public class GenerateSqlFactory {
  ...
  public static String baseSql(String expression, String tableName) {
    builder().SELECT(expression).FROM(tableName);
    return sql();
  }
  ...
  public static String derived(String expression, String tableName, String where) {
    builder().SELECT(expression).FROM(tableName).WHERE(where);
    return sql();
  }
  ...
  public static String joinSql(
    ...
    builder().SELECT(expression).FROM(tableName).WHERE(where).JOIN(joinTable);
    return sql();
  }
  ...
  public static String leftJoin(
      String expression, String table, String where, String leftJoinTable) {
    builder().SELECT(expression).FROM(table).WHERE(where).LEFT_OUTER_JOIN(leftJoinTable);
    return sql();
  }
  ...
  public static String rightJoin(
      String expression, String table, String where, String rightJoinTable) {
    builder().SELECT(expression).FROM(table).WHERE(where).RIGHT_OUTER_JOIN(rightJoinTable);
    return sql();
  }
  ...
  public static String orderBy(String tableName, String expression, String where, String orderBy) {
    builder().SELECT(expression).FROM(tableName).WHERE(where).ORDER_BY(orderBy);
    return sql();
  }
