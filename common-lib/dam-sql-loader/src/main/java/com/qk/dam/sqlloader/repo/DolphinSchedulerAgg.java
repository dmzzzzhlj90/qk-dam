...
public class DolphinSchedulerAgg {
    ...
    public static List<DolphinProcessInstanceVO> schedulerProcessInstanceInfo(String prevHourDate, String nowDate, String schedulerUserName) {
        try {
            List<Entity> query =
                    use.query(" SELECT a.process_definition_code,a.`name`,a.state,\n" +
