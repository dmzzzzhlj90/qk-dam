...
public class DolphinProcessInstanceVO {
  ...
  public DolphinProcessInstanceVO(
      Long process_definition_code, String name, int state, String user_name, String update_time) {
  ...
  public boolean equals(Object o) {
    ...
    return getProcess_definition_code().equals(that.getProcess_definition_code())
