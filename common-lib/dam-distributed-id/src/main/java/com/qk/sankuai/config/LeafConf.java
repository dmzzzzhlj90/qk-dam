...
public class LeafConf {
    ...
    public String toString() {
        return "LeafConf{" +
                "leafSegmentEnable=" + leafSegmentEnable +
                ", leafSnowflakeEnable=" + leafSnowflakeEnable +
                ", leafSnowflakePort=" + leafSnowflakePort +
                ", leafSnowflakeZkAddress='" + leafSnowflakeZkAddress + '\'' +
                '}';
    }
}
