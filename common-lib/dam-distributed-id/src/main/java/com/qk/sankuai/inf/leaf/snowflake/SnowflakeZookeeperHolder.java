...
import com.qk.sankuai.inf.leaf.common.*;
import com.qk.sankuai.inf.leaf.snowflake.exception.CheckLastTimeException;
...
public class SnowflakeZookeeperHolder {
    ...
    private static final String PREFIX_ZK_PATH = "/snowflake/" + PropertyFactory.getProperties().getProperty("com.sankuai.inf.leaf.name");
    private static final String PROP_PATH = System.getProperty("java.io.tmpdir") + File.separator + PropertyFactory.getProperties().getProperty("com.sankuai.inf.leaf.name") + "/leafconf/{port}/workerID.properties";
